...
class ZipBackupCreator:
    ...
    def __copy_dirs_to_backup(self, backup_dir):
        for directory in self.__paths_config.dirs_to_backup:
            ...
            self.__logger.info("Copied {source} to {dest}".format(source=source_dir, dest=destination_dir))
    ...
    def __create_zip_file(self, backup_dir, zip_file_path):
        ...
        self.__logger.info("Created zip: {zipFilePath}. File size: {fileSizeMB:.3f}"

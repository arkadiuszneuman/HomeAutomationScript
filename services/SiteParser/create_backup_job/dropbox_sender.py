...
class DropboxSender:
    ...
    def __backup_file(self, file_path):
        ...
        print("Uploading file {file} to Dropbox".format(file=file_name))
        with open(file_path, "rb") as file:
            self.dbx.files_upload(file.read(), file_name)

        print("Uploaded file {file} to Dropbox".format(file=file_name))
    ...
    def __remove_old_backups(self):
        ...
        if files_count_to_get > 0:
            ...
            for file in files_to_delete:
                ...
                print("Removed old backup file: {removed_backup_file_name}".format(removed_backup_file_name=file.name))
